...
//    int homeScreenIndex ;
//    int articleScreenIndex;
//    int searchScreenIndex ;
//    int profileScreenIndex ;
//    int currentScreenIndex ;
//
//   MainScreenBottomNavigation({Key? key,
//     required this.homeScreenIndex,
//   required this.articleScreenIndex,
//   required this.searchScreenIndex,
//   required this.profileScreenIndex ,
//   required this.currentScreenIndex}) : super(key: key);
//
//
//   @override
...
//                     label: 'Home',
//                     isCurrentItem: currentScreenIndex == homeScreenIndex,
//                     onTap: () => mainBloc.add(
//                       MainNavigateTo(
